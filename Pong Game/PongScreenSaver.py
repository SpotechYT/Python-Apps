...
def draw_dashed_line(surf, color, start_pos, end_pos, width=1, dash_length=15):
    x1, y1 = start_pos
    x2, y2 = end_pos
    dl = dash_length
...
rectleft = pygame.Rect(10, centerY-75+ballY, 25, 150)
rectright = pygame.Rect(width-40, centerY-75+ballY, 25, 150)
ball = pygame.Rect(centerX-10+ballX, centerY+ballY, 20, 20)

#Center Line
draw_dashed_line(screen, White, (centerX, 0), (centerX, height*2), dash_length=15)
...
while True:
    ...
    #Center Line
    draw_dashed_line(screen, White, (centerX, 0), (centerX, height), dash_length=15)
